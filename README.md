...
Start services: make dev-hot-reload

Make code changes (auto-reload will apply changes)

Run database seeding: make seed

Access frontend: http://localhost:5174

Test APIs using the provided documentation
